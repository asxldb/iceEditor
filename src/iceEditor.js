...
ice.editor.prototype.menuHTML=function(){
	...
	//音乐
	this.createMenu({name:'music',icon:'music',id:this.musicId,popup:{width:320,height:80,title:'添加音乐',content:'<div class="iceEditor-music"><label>音乐链接：</label><input type="text" id="'+this.musicInputId+'" name="url" class="iceEditor-link" placeholder="链接地址" value=""/><a href="javascript:;" class="iceEditor-btn">确定</a></div>'},
		success:function(e,z){
	...
	//附件
	this.createMenu({name:'files',icon:'files',id:this.filesId,popup:{width:320,height:200,title:'附件上传',content:'<div class="iceEditor-insertImage"><input type="file" class="iceEditor-uploadInput" id="'+this.filesUploadId+'" name="file[]" multiple/><div><svg class="iceEditor-icon iceEditor-uploadIcon" aria-hidden="true"><use xlink:href="#icon-files"></use></svg></div><label for="'+this.filesUploadId+'" class="iceEditor-uploadBtn">点击上传附件</label></div>'},
		success:function(e,z){
	...
	//添加图片
	this.createMenu({name:'insertImage',icon:'pic',id:this.imageId,popup:{width:320,height:250,title:'图片上传',content:'<div class="iceEditor-insertImage"><div class="iceEditor-group"><label>URL：</label><input type="text" name="url" class="iceEditor-insertImageUrl" placeholder="网络图片地址" value=""/></div><div class="iceEditor-group"><label>宽：</label><input type="text" name="width" class="iceEditor-inputWidth" placeholder="宽" value=""/><label>高：</label><input type="text" name="height" class="iceEditor-inputHeight" placeholder="高" value=""/><a href="javascript:;" class="iceEditor-btn">确定</a></div><input type="file" class="iceEditor-uploadInput" id="'+this.imgUploadId+'" name="file[]" accept="image/*" multiple/><div><svg class="iceEditor-icon iceEditor-uploadIcon" aria-hidden="true"><use xlink:href="#icon-pic"></use></svg></div><label for="'+this.imgUploadId+'" class="iceEditor-uploadBtn">点击上传图片</label></div>'},
		success:function(e,z){
	...
	//添加视频
	this.createMenu({name:'video',icon:'video',id:this.videoId,popup:{width:320,height:170,title:'添加视频',content:'<div class="iceEditor-video"><div><label><input name="video" type="radio" checked value="1"/>自定义</label><label><input name="video" type="radio" value="2"/>B站</label><label><input name="video" type="radio" value="3"/>优酷</label></div><div>URL：<input type="text" name="url" class="iceEditor-videoUrl" placeholder="网络图片地址" value=""/></div><div><label>宽：</label><input type="text" name="width" class="iceEditor-inputWidth" placeholder="px" value=""/><label>高：</label><input type="text" name="height" class="iceEditor-inputHeight" placeholder="px" value=""/><a href="javascript:;" class="iceEditor-btn">确定</a></div></div>'},
		success:function(e,z){
